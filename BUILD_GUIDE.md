...
- **Exécutable** : `src-tauri/target/release/proto-tauri.exe`
...
- Copiez `proto-tauri.exe` sur la borne
...
```bash
open src-tauri/gen/apple/proto_tauri.xcodeproj
```
...
Éditez `src-tauri/gen/apple/proto_tauri_iOS/Info.plist` :
